...
de.OfficeIsRunning=Ihre Office-Anwendung muss geschlossen werden, um mit der Installation fortzufahren. Wenn Sie auf 'OK' klicken, wird die Anwendung geschlossen.
...
de.RequiredMsg=%d Datei(en) mit ca. %s MiB muss/müssen von den Microsoft-Servern heruntergeladen werden. Klicken Sie 'Weiter', um den Download zu beginnen.
