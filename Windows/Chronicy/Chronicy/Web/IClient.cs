...
namespace Chronicy.Web
{
    public interface IClient : IDisposable
    {
        ...
        Task<Tuple<ResponseInfo, string>> UploadAsync(string url, string body, string method, HeaderCollection headers = null);
        Task<Tuple<ResponseInfo, byte[]>> UploadRawAsync(string url, string body, string method, HeaderCollection headers = null);
        Task<Tuple<ResponseInfo, T>> UploadJsonAsync<T>(string url, string body, string method, HeaderCollection headers = null);
    }
}
